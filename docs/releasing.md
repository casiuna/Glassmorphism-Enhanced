...
The independent version line begins at **1.0.0**, with Git tag / GitHub Release **v1.0.0** after approval. `komari-theme.json.version` is the sole source of truth; do not add `package.json.version`.
